<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-red-400">Hello, I'm</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Renzo Toledo</h1>
      <div class="py-2">
        <h1
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "Computer Science Student", "Tech Enthusiast"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
...
.pict {
  box-shadow: 0px 0px 73px -9px #F8A0BD;
-webkit-box-shadow: 0px 0px 73px -9px #F8A0BD;
-moz-box-shadow: 0px 0px 73px -9px #F8A0BD;
}
