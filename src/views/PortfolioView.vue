      ...
      items: [
        {
          ...
          imageUrl: 'asteroids',
          status: 'Asteroids is a space-themed multidirectional shooter arcade game. This was made using pure python and PyGame library.',
          tech: 'Python, PyGame',
        ...
        },
        {
          ...
          imageUrl: 'sorting',
          status: 'Java Sorting Visualizer is a desktop application that visualizes the sorting algorithms. This was made using Java Swing.',
          tech: 'Java, Swing',
        ...
        },
        {
          ...
          imageUrl: 'inprogress',
          status: 'Code in progress. Please check back later.',
          tech: '',
          github: '',
          demo: ''
        },
              ...
              <div
                ...
                <div class="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-lg">
                  ...
                  <div class="w-full text-left text-[10px] text-[#c1c1c1] md:text-xs lg:text-sm">
                    {{ item.status }}</div>
                  <div class="w-full mt-4 text-normal text-sm text-left text-red-500">
                    {{ item.tech }}
                  </div>
