    ...
    <article data-page="about">
      <header>
        ...
        >
          ...
          <h4
            class="text-base font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-red-300"
          >
            ...
            <div v-for="item in items" :key="item.id">
              ...
              >
                ...
                >
                  ...
                  <div
                    class="w-full mt-4 text-normal text-sm text-left text-red-500"
                  >
                    {{ item.tech }}
                  </div>
